...
public class Contract {
    ...
    public Contract(LinkedHashMap map) {
        this.totalSize = MapUtil.getValue(map, "totalSize");
        this.done = MapUtil.getValue(map, "done");
        
        MapUtil.getNodeArraylist(map, "records").stream().forEach(r -> {
    ...
    public void evaluateTicketDesignator(
        ...
        /*lSalesforceAccounts.forEach(s -> {
            s.getContract().getRecords().stream()
                    ...
                    .filter(r -> !r.getStatus().equals(Constants.EMPTY))
                    .forEach(r -> {
                        System.out.println(s.getId()+" "+r.getTicket_Designator__c());
    ...
    public void printResult(List<ContractData> lContractDatas) {
        ...
        System.out.println("INTERNAL RESULT: ");
        lContractDatas.stream()
                ...
                .forEach(s -> {
                    ...
                    System.out.println(s.getEvaluation() + " " + count);
                });
    }
